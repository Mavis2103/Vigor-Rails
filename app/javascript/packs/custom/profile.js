...
(async () => {
  document.body.addEventListener("click", (e) => {
    let target = e.target;
    if (
      target.classList.contains("MainPage__profileFeed-bodyComment-all__cmt")
    ) {
      ...
      setInterval(async () => {
        ...
        rq.data.forEach((cmt) => {
          if (post_id_cmt == cmt.post_id) {
            ...
            commenters.classList.add(
              "MainPage__profileFeed-bodyComment-commenters"
            );
            ...
            text_content.classList.add(
              "MainPage__profileFeed-bodyComment-username"
            );
